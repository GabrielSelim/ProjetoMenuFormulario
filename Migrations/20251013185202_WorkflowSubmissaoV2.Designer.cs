...
namespace FormEngineAPI.Migrations
{
    ...
    [Migration("20251013185202_WorkflowSubmissaoV2")]
    partial class WorkflowSubmissaoV2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FormEngineAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 13, 18, 52, 2, 332, DateTimeKind.Utc).AddTicks(1115),
                            Email = "admin@formengine.com",
                            Name = "Admin",
                            PasswordHash = "$2a$11$IkRglqJZ.T2mdd5D8ngasOXskx1SKOyD5rF9o8oTTOTE98c80Ah8S",
                            Role = "admin",
                            UpdatedAt = new DateTime(2025, 10, 13, 18, 52, 2, 332, DateTimeKind.Utc).AddTicks(1121)
                        });
                });
